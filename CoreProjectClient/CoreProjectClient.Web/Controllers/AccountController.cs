...
namespace CoreProjectClient.Web.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel loginModel,string returnUrl = null)
        {
            ...
            var user = await _userService.GetUserConfirm(loginModel.Email, loginModel.Password);
            ...
            ValidationMessage("validationmessage", "danger", "Password Or Email Wrong!");
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            string response = await _userService.AddUser(user);
            if (response == null)
            {
                ValidationMessage("validationmessage", "warning", "Email Using!");
